...
namespace BasketballClub_Rest.Migrations
{
    ...
    [Migration("20220113121249_UpdateSelectionPlayer")]
    partial class UpdateSelectionPlayer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayerSelection", b =>
                {
                    ...
                    b.Property<int>("SelectionsSelectionID")
                        .HasColumnType("int");

                    b.HasKey("PlayersPlayerID", "SelectionsSelectionID");

                    b.HasIndex("SelectionsSelectionID");
            ...
            modelBuilder.Entity("PlayerSelection", b =>
                {
                    b.HasOne("BasketballClub_Rest.Domain.Player", null)
                        .WithMany()
                        .HasForeignKey("PlayersPlayerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BasketballClub_Rest.Domain.Selection", null)
                        .WithMany()
                        .HasForeignKey("SelectionsSelectionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
